// foeEach , filter , reducer ,map ,set

const arr = [10,34,22,67,81,76];

arr.forEach((Number) =>{
    console.log(Number);
});

const arr1 = [10,34,22,67,81,76];
 let sum = 0;
arr.forEach((Number) =>{
    sum +=Number;
});
...
const arr3 = [20,80,60,40,10,90];

let newarr = arr3.filter((number) => number>50)

console.log(newarr);



const newarr1 = arr3.map((number) => number*3)
console.log(newarr1)
...
const products1 = [
    { item: "Bhindi", price: 200, inStock: true },
    { item: "Sonpapdi", price: 40, inStock: true },
    { item: "Rice", price: 100, inStock: false }
];

const totalPrice = products1.reduce((accumulator, currentValue) => {
...
console.log(totalPrice); // 240


// Data structure: set

const arr6 = [10,20,30,10,25,15,10,20];
console.log(arr6);

const s1 = new Set(arr6);
s1.add(11);
console.log(s1);
